...
################################################################################
## Form generated from reading UI file 'Indivo_Cancellation_Info.ui'
##
...
"color: rgb(255, 0, 0);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.HeaderLabel.setText(QCoreApplication.translate("Dialog", u"Indivo Cancellation Info", None))
        self.label.setText("")
    # retranslateUi
