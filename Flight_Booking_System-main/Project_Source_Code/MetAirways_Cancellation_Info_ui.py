...
################################################################################
## Form generated from reading UI file 'MetAirways_Cancellation_Info.ui'
##
...
"color: rgb(255, 0, 0);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.HeaderLabel.setText(QCoreApplication.translate("Dialog", u"MetAirways Cancellation Info", None))
